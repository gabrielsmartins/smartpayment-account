...
public class CreateAccountControllerTest {
    ...
    @Test
    @DisplayName("Given Account When Create Then Return Created Account")
    public void givenAccountWhenCreateThenReturnCreatedAccount() throws Exception {
        ...
        when(useCase.create(any(Account.class))).thenAnswer(invocation -> invocation.getArgument(0));
