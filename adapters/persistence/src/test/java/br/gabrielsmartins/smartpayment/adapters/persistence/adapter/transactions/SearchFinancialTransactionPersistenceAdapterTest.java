...
public class SearchFinancialTransactionPersistenceAdapterTest {

    private SearchFinancialTransactionPersistenceAdapter adapter;
    private SearchFinancialTransactionPersistenceService service;
    private FinancialTransactionPersistenceMapper mapper;

    @BeforeEach
    public void setup(){
        this.service = mock(SearchFinancialTransactionPersistenceService.class);
        this.mapper = new FinancialTransactionPersistenceMapperImpl();
        this.adapter = new SearchFinancialTransactionPersistenceAdapter(service, mapper);
    }
    ...
    public void givenAccountIdAndIntervalThenReturnFinancialTransactionList(){
        ...
        when(service.findByAccountIdAndInterval(any(UUID.class), any(LocalDateTime.class), any(LocalDateTime.class))).thenReturn(Collections.singletonList(transactionEntity));
    ...
    public void givenCustomerIdAndIntervalThenReturnFinancialTransactionList(){
        ...
        when(service.findByCustomerIdAndInterval(any(UUID.class), any(LocalDateTime.class), any(LocalDateTime.class))).thenReturn(Collections.singletonList(transactionEntity));
